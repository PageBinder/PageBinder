...
- **Only printouts are searched by content** (2026-09-25). The text of a PDF inserted as a printout is indexed; files that are only attached contribute their names, never their contents. Further steps (word highlighting, OCR, Word printouts) are listed in `docs/dev/FUTURE_FEATURES.md`.
