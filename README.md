...
Local-only, folder-based notebook application in the style of classic desktop OneNote.
The full design is in [PROGRAM_DESCRIPTION.md](PROGRAM_DESCRIPTION.md). This build covers phases 1 to 7: **Foundation**, **Documents**, **Attachments**, **Search**, **History and verification**, **Templates and copy or move**, and **Scale**.
